...
">
  ...
  <div style="
    ...
    color: #1A6FFF; padding: 4px 12px; border-radius: 20px;
  ...
  <div style="display: flex; gap: 12px; flex-wrap: wrap;">
    <!-- 摘要数据标签 -->
    <div style="
      background: rgba(26,111,255,0.06); border-radius: 8px;
      padding: 8px 16px; color: #1A1A1A; border: 1px solid rgba(26,111,255,0.15);
    ">
      <span style="font-size: 11px; color: #8C8C8C;">核心指标</span>
      <div style="font-size: 20px; font-weight: 700; color: #1A6FFF;">数值</div>
    </div>
    <!-- 可复用，添加更多标签 -->
  </div>
</header>
